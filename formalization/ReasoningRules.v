...
(** logical rules *)
| rw_imply_prt : forall Γ Δ e τ (w w' : Γ ;;; Δ ||- e : τ) (ϕ ϕ': rwpre) (ψ ψ' : rwpred),
...
| rw_assign_prt : forall Γ Δ e k τ (w : (Δ ++ Γ) |- e : τ) ϕ θ (ψ : rwpred) (w' : Γ ;;; Δ ||- (LET k := e) : UNIT),
...
(** logical rules *)
| rw_imply_tot : forall Γ Δ e τ (w w' : Γ ;;; Δ ||- e : τ) (ϕ ϕ': rwpre) (ψ ψ' : rwpred),
...
| rw_assign_tot : forall Γ Δ e k τ (w : (Δ ++ Γ) |- e : τ) ϕ θ (ψ : rwpred) (w' : Γ ;;; Δ ||- (LET k := e) : UNIT),
