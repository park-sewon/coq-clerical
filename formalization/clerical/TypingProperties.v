...
Section RestrictedTyping.
  ...
  Proof.
    +
      dependent destruction w;
        try(
            apply phas_type_rw_has_type_rw in p;
      ...
      (* apply phas_type_rw_has_type_rw in p1, p2. *)
      (* apply has_type_ro_rw. *)
      (* apply has_type_rw_Seq; auto. *)
      (* dependent destruction p. *)
      (* apply phas_type_ro_has_type_ro in p. *)
      (* apply has_type_ro_rw. *)
      (* apply (has_type_rw_Assign _ _ _ τ); auto. *)
      (* apply phas_type_rw_has_type_rw in p. *)
      (* apply has_type_ro_rw. *)
      (* apply (has_type_rw_Newvar _ _ _ _ τ); auto. *)
