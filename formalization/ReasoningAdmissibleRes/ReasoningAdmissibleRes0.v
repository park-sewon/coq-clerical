...
(* Limit *)
| r_ro_lim_prt : forall Γ e (w : (INTEGER :: Γ) |- e : REAL) (ϕ : sem_ro_ctx Γ -> Prop) θ (w' : Γ |- Lim e : REAL) (ψ : R -> sem_ro_ctx Γ -> Prop),
...
(* Limit *)
| r_ro_lim_tot : forall Γ e (w : (INTEGER :: Γ) |- e : REAL) (ϕ : sem_ro_ctx Γ -> Prop) θ (w' : Γ |- Lim e : REAL) (ψ : R -> sem_ro_ctx Γ -> Prop),
