...
Proof.
    ...
    (* proving loop invariant ϕ *)
...

      {
        ...
        
        {
          ...
          repeat split; auto.
          lia.
          rewrite (var_access_typing_irrl _ _ _ (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse h4))))) w).
          rewrite (var_access_typing_irrl _ _ _ (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse h6))))) w).
          rewrite p3.
          simpl.
          field_simplify.
          repeat apply lp.
...

  {
    ...
    rewrite (var_access_typing_irrl _ _ _ (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse (has_type_ro_Var_S_inverse w''))) w) in H.
